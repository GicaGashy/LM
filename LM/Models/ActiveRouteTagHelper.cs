...
namespace LM
{
    ...
    public class ActiveRouteTagHelper : TagHelper
    {
        ...
        private void MakeActive(TagHelperOutput output)
        {
            ...
            if (classAttr == null)
            {
                classAttr = new TagHelperAttribute("class", "g-active");
                output.Attributes.Add(classAttr);
            }
            else if (classAttr.Value == null || classAttr.Value.ToString().IndexOf("g-active") < 0)
            {
                output.Attributes.SetAttribute("class", classAttr.Value == null
                    ? "g-active"
                    : classAttr.Value.ToString() + " g-active");
            }
        }
    }
}